...
cd /
mkdir -pm 774 /s3xfer/S3/laa-ccms-inbound-${local.application_data.accounts[local.environment]}
mkdir -pm 774 /s3xfer/S3/laa-ccms-outbound-${local.application_data.accounts[local.environment]}
mkdir -pm 774 /s3xfer/S3/laa-cis-inbound-${local.application_data.accounts[local.environment]}
mkdir -pm 774 /s3xfer/S3/laa-cis-outbound-${local.application_data.accounts[local.environment]}
mkdir -m 774 cdstemp
echo 's3fs#laa-ccms-outbound-${local.application_data.accounts[local.environment]} /s3xfer/S3/laa-ccms-outbound-${local.application_data.accounts[local.environment]} fuse _netdev,allow_other,iam_role=auto 0 0' >> /etc/fstab
echo 's3fs#laa-ccms-inbound-${local.application_data.accounts[local.environment]} /s3xfer/S3/laa-ccms-inbound-${local.application_data.accounts[local.environment]} fuse _netdev,allow_other,iam_role=auto 0 0' >> /etc/fstab
echo 's3fs#laa-cis-outbound-${local.application_data.accounts[local.environment]} /s3xfer/S3/laa-cis-outbound-${local.application_data.accounts[local.environment]} fuse _netdev,allow_other,iam_role=auto 0 0' >> /etc/fstab
echo 's3fs#laa-cis-inbound-${local.application_data.accounts[local.environment]} /s3xfer/S3/laa-cis-inbound-${local.application_data.accounts[local.environment]} fuse _netdev,allow_other,iam_role=auto 0 0' >> /etc/fstab
