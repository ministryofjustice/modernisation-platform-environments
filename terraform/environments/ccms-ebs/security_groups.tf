...
resource "aws_security_group_rule" "ingress_traffic_ebsdb" {
  ...
  from_port         = each.value.from_port
  to_port           = each.value.to_port
  cidr_blocks       = [data.aws_vpc.shared.cidr_block, local.application_data.accounts[local.environment].lz_aws_subnet_env, local.application_data.accounts[local.environment].lz_aws_workspace_nonprod_subnet_env, local.application_data.accounts[local.environment].lz_aws_workspace_prod_subnet_env, local.application_data.accounts[local.environment].lz_aws_appstream_subnet_a, local.application_data.accounts[local.environment].lz_aws_appstream_subnet_b]
}
