...
#   count = local.is-development || local.is-test ? 1 : 0
#   fqdn  = "ccms-${local.application_name_ssogen}-as1.${var.networking[0].business-unit}-${local.environment}.modernisation-platform.service.justice.gov.uk"
#   port  = 5443
#   type  = "TCP"
# }
...
#   count = local.is-development || local.is-test ? 1 : 0
#   fqdn  = "ccms-${local.application_name_ssogen}-as2.${var.networking[0].business-unit}-${local.environment}.modernisation-platform.service.justice.gov.uk"
#   port  = 5443
#   type  = "TCP"
# }
