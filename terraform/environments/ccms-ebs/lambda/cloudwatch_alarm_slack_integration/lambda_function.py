...
class NotificationService:
  ...
  def send_notification(
      ...
      if type == "GuardDuty":
          ...
          threatcount = detail.get("service", {}).get("count", "N/A")
          firstseennofmt = detail.get("service", {}).get("eventFirstSeen", "N/A")
          lastseennofmt = detail.get("service", {}).get("eventLastSeen", "N/A")
...
def lambda_handler(event, context):
  ...
  Triggered by SNS Topic subscriptions to CloudWatch Alarms and GuardDuty findings.
  """
  tracemalloc.start()
