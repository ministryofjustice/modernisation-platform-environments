...
resource "aws_ebs_volume" "arch" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "arch")) },
...
resource "aws_ebs_volume" "redoA" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "redoA")) },
...
resource "aws_ebs_volume" "techst" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "techst")) },
    { device-name = "/dev/sdm" },
...
resource "aws_ebs_volume" "backup_prod" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "backup-prod")) },
...
resource "aws_ebs_volume" "redoB" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "redoB")) },
...
resource "aws_ebs_volume" "diag" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "diag")) },
    { device-name = "/dev/sdp" },
...
resource "aws_ebs_volume" "dbf01" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "dbf01")) },
    { device-name = "/dev/sdq" },
...
resource "aws_ebs_volume" "dbf02" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "dbf02")) },
    { device-name = "/dev/sdr" },
...
resource "aws_ebs_volume" "dbf03" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "dbf03")) },
    { device-name = "/dev/sds" },
...
resource "aws_ebs_volume" "dbf04" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "dbf04")) },
    { device-name = "/dev/sdt" },
...
resource "aws_ebs_volume" "swap2" {
  ...
  kms_key_id        = data.aws_kms_key.ebs_shared.key_id
  tags = merge(local.tags,
    { Name = lower(format("%s:%s/%s", local.application_data.accounts[local.environment].instance_role_ebsdb, local.volume_prefix,  "swap2")) },
    { device-name = "/dev/sdx" },
