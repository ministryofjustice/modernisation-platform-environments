...
locals {
  ...
  lambda_folder_name = ["lambda_delivery", "certificate_monitor", "ftp_lambda_layer", "ftp_client_latest", "functional_latest", "layer_latest", "payment_load_monitor", "red_button_trigger"]
  data_subnets = [
