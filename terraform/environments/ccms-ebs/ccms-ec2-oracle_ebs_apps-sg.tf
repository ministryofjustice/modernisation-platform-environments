...
### INGRESS
# HTTP
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_80" {
...
# HTTPS
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_443" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "HTTPS"
  protocol          = "TCP"
  from_port         = 443
...
# SSH
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_22" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "SSH"
  protocol          = "TCP"
  from_port         = 22
...
# Oracle LDAP
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_1389" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
...
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_152x" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
...
# Oracle
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_5101" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "Oracle"
  protocol          = "TCP"
  from_port         = 5101
...
# Oracle
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_5401" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "Oracle"
  protocol          = "TCP"
  from_port         = 5401
...
# Oracle
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_5575" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "Oracle"
  protocol          = "TCP"
  from_port         = 5575
...
# Oracle LDAP SSL
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_1636" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
...
# Oracle
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_10401" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
  description       = "Oracle"
  protocol          = "TCP"
  from_port         = 10401
...
# Oracle HTTP
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_800x" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
...
# Oracle HTTPS
resource "aws_vpc_security_group_ingress_rule" "ingress_traffic_ebsapps_4443" {
  security_group_id = aws_security_group.ec2_sg_ebsapps.id
