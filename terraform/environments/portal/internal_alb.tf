locals {
  ...
  internal_lb_http_hosts   = ["mp-portal-oim-internal.aws.dev.legalservices.gov.uk", "mp-portal-oam-internal.aws.dev.legalservices.gov.uk", "mp-portal-idm-console.aws.dev.legalservices.gov.uk"]
}
