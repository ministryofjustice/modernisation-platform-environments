#!/bin/bash
terraform import 'module.baseline.module.s3_bucket["int-nomis-lb-access-logs"].aws_s3_bucket.default' 'arn:aws:s3:::int-nomis-lb-access-logs20230105131538061200000001'
