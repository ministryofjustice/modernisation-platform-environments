...
| <a name="input_restoring_from_snapshot"></a> [restoring\_from\_snapshot](#input\_restoring\_from\_snapshot) | Instance is being restored from an existing Oracle database snapshot | `bool` | `false` | no |
