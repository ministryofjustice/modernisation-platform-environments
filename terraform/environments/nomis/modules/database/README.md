...
| <a name="input_restoring_from_snapshot"></a> [restoring_from_snapshot](#input_restoring_from_snapshot)       | Instance is being restored from an existing Oracle database snapshot                                                                          | `bool`                                                                                                                                                     | `false`        |    no    |
