module "patch_manager" {
  ...
  patch_schedules             = local.baseline_all_environments.patch_manager.patch_schedules
  patch_tag_key               = local.baseline_all_environments.patch_manager.patch_tag_key
  maintenance_window_cutoff   = local.baseline_all_environments.patch_manager.maintenance_window_cutoff
  maintenance_window_duration = local.baseline_all_environments.patch_manager.maintenance_window_duration
  patch_classifications       = local.baseline_all_environments.patch_manager.patch_classifications
