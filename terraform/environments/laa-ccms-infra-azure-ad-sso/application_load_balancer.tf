...
#
#  tags = merge(local.tags,
#    { Name = lower(format("lb-%s-%s-vision-pc", local.application_name, local.environment)) }
#  )
#}
#
##
...
#}
#
#resource "aws_lb_target_group_attachment" "ebs_vision_db_pc_attachment" {
#  target_group_arn = aws_lb_target_group.ebs_vision_db_pc_tg_http.arn
#  target_id        = aws_instance.ec2_oracle_vision_ebs_preclone.id
#  port             = 8000
#}
#
#
