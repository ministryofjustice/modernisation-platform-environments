...
| <a name="input_environment"></a> [environment](#input_environment)                                     | The environment where resources are to be created (development, test, preprod, production)                     | `string`                                                                                                                                                                                     | n/a     |   yes    |
