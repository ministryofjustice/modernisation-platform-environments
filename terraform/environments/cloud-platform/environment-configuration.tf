locals {
  environment_configurations = {
    development = {
      account_subdomain_name = "development.temp.cloud-platform.service.justice.gov.uk"
      ns_records = [
    ...
    preproduction = {
      account_subdomain_name = "preproduction.temp.cloud-platform.service.justice.gov.uk"
      ns_records = [
        "ns-81.awsdns-10.com.",
    ...
    nonlive = {
      account_subdomain_name = "nonlive.temp.cloud-platform.service.justice.gov.uk"
      ns_records = [
