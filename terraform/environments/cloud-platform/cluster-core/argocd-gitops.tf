...
# ArgoCD GitOps locals (is_argocd_hub, environments_repo, bu_configs,
# bu_appprojects, argocd_codeconnection_*) are defined in locals.tf, matching
# the house convention that resource files carry no locals.
