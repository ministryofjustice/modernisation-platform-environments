...
-- Started on 2023-01-25 12:33:03 GMT
...
--
-- TOC entry 3969 (class 2606 OID 65696)
-- Name: Addresses Addresses_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Addresses"
    ADD CONSTRAINT "Addresses_pkey" PRIMARY KEY ("addressID");


--
-- TOC entry 3971 (class 2606 OID 65704)
-- Name: Applicants Applicants_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Applicants"
    ADD CONSTRAINT "Applicants_pkey" PRIMARY KEY ("ApplicantID");


--
-- TOC entry 3973 (class 2606 OID 65709)
-- Name: AttendanceNoteCodes AttendanceNoteCodes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."AttendanceNoteCodes"
    ADD CONSTRAINT "AttendanceNoteCodes_pkey" PRIMARY KEY ("AttendanceNoteCodeID");


--
-- TOC entry 3975 (class 2606 OID 65717)
-- Name: AttendanceNotes AttendanceNotes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."AttendanceNotes"
    ADD CONSTRAINT "AttendanceNotes_pkey" PRIMARY KEY ("AttendanceNoteID");


--
-- TOC entry 3977 (class 2606 OID 65725)
...
--
-- TOC entry 3979 (class 2606 OID 65730)
...
--
-- TOC entry 3981 (class 2606 OID 65735)
...
--
-- TOC entry 3983 (class 2606 OID 65740)
-- Name: CAOrderTypes CAOrderTypes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."CAOrderTypes"
    ADD CONSTRAINT "CAOrderTypes_pkey" PRIMARY KEY ("caOrderTypeID");


--
-- TOC entry 3987 (class 2606 OID 65753)
-- Name: CaseReviewStatus CaseReviewStatus_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."CaseReviewStatus"
    ADD CONSTRAINT "CaseReviewStatus_pkey" PRIMARY KEY ("caseReviewStatusID");


--
-- TOC entry 3985 (class 2606 OID 65748)
-- Name: CaseReviews CaseReviews_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."CaseReviews"
    ADD CONSTRAINT "CaseReviews_pkey" PRIMARY KEY ("caseReviewID");


--
-- TOC entry 3989 (class 2606 OID 65758)
-- Name: CaseStatus CaseStatus_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."CaseStatus"
    ADD CONSTRAINT "CaseStatus_pkey" PRIMARY KEY ("caseStatusID");


--
-- TOC entry 3991 (class 2606 OID 65763)
-- Name: ChildRelationships ChildRelationships_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."ChildRelationships"
    ADD CONSTRAINT "ChildRelationships_pkey" PRIMARY KEY ("childRelationshipID");


--
-- TOC entry 3993 (class 2606 OID 65771)
-- Name: Children Children_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Children"
    ADD CONSTRAINT "Children_pkey" PRIMARY KEY ("childID");


--
-- TOC entry 3997 (class 2606 OID 65784)
-- Name: ContactTypes ContactTypes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."ContactTypes"
    ADD CONSTRAINT "ContactTypes_pkey" PRIMARY KEY ("contactTypeID");


--
-- TOC entry 3995 (class 2606 OID 65779)
-- Name: Contacts Contacts_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Contacts"
    ADD CONSTRAINT "Contacts_pkey" PRIMARY KEY ("contactID");


--
-- TOC entry 3999 (class 2606 OID 65789)
-- Name: Countries Countries_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--
...
--
-- TOC entry 4001 (class 2606 OID 65797)
...
--
-- TOC entry 4003 (class 2606 OID 65802)
-- Name: DeletedTipstaffRecords DeletedTipstaffRecords_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."DeletedTipstaffRecords"
    ADD CONSTRAINT "DeletedTipstaffRecords_pkey" PRIMARY KEY ("TipstaffRecordID", "deletedReasonID");


--
-- TOC entry 4005 (class 2606 OID 65810)
...
--
-- TOC entry 4009 (class 2606 OID 65823)
-- Name: DocumentStatus DocumentStatus_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."DocumentStatus"
    ADD CONSTRAINT "DocumentStatus_pkey" PRIMARY KEY ("DocumentStatusID");


--
-- TOC entry 4011 (class 2606 OID 65828)
-- Name: DocumentTypes DocumentTypes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."DocumentTypes"
    ADD CONSTRAINT "DocumentTypes_pkey" PRIMARY KEY ("documentTypeID");


--
-- TOC entry 4007 (class 2606 OID 65818)
-- Name: Documents Documents_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Documents"
    ADD CONSTRAINT "Documents_pkey" PRIMARY KEY ("documentID");


--
-- TOC entry 4013 (class 2606 OID 65847)
...
--
-- TOC entry 4017 (class 2606 OID 65874)
-- Name: FaxCodes FaxCodes_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."FaxCodes"
    ADD CONSTRAINT "FaxCodes_pkey" PRIMARY KEY ("faxCodeID");


--
-- TOC entry 4015 (class 2606 OID 65859)
-- Name: Genders Genders_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Genders"
    ADD CONSTRAINT "Genders_pkey" PRIMARY KEY ("genderID");


--
-- TOC entry 4019 (class 2606 OID 65893)
-- Name: Nationalities Nationalities_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Nationalities"
    ADD CONSTRAINT "Nationalities_pkey" PRIMARY KEY ("nationalityID");


--
-- TOC entry 4049 (class 2606 OID 121687)
-- Name: Passports PK_dbo.Passports; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "PK_dbo.Passports" PRIMARY KEY ("passportID");


--
-- TOC entry 3967 (class 2606 OID 64336)
...
--
-- TOC entry 4021 (class 2606 OID 65917)
-- Name: PoliceForces PoliceForces_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."PoliceForces"
    ADD CONSTRAINT "PoliceForces_pkey" PRIMARY KEY ("policeForceID");


--
-- TOC entry 4023 (class 2606 OID 65937)
-- Name: ProtectiveMarkings ProtectiveMarkings_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."ProtectiveMarkings"
    ADD CONSTRAINT "ProtectiveMarkings_pkey" PRIMARY KEY ("protectiveMarkingID");


--
-- TOC entry 4025 (class 2606 OID 65960)
-- Name: Respondents Respondents_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Respondents"
    ADD CONSTRAINT "Respondents_pkey" PRIMARY KEY ("respondentID");


--
-- TOC entry 4027 (class 2606 OID 65966)
-- Name: Results Results_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Results"
    ADD CONSTRAINT "Results_pkey" PRIMARY KEY ("resultID");


--
-- TOC entry 4029 (class 2606 OID 65973)
...
--
-- TOC entry 4031 (class 2606 OID 65986)
...
--
-- TOC entry 4033 (class 2606 OID 65996)
-- Name: SkinColours SkinColours_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."SkinColours"
    ADD CONSTRAINT "SkinColours_pkey" PRIMARY KEY ("skinColourID");


--
-- TOC entry 4035 (class 2606 OID 66009)
-- Name: SolicitorFirms SolicitorFirms_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."SolicitorFirms"
    ADD CONSTRAINT "SolicitorFirms_pkey" PRIMARY KEY ("solicitorFirmID");


--
-- TOC entry 4041 (class 2606 OID 66038)
-- Name: Solicitors Solicitors_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Solicitors"
    ADD CONSTRAINT "Solicitors_pkey" PRIMARY KEY ("solicitorID");


--
-- TOC entry 4039 (class 2606 OID 66030)
...
--
-- TOC entry 4037 (class 2606 OID 66016)
-- Name: TipstaffPoliceForces TipstaffPoliceForces_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."TipstaffPoliceForces"
    ADD CONSTRAINT "TipstaffPoliceForces_pkey" PRIMARY KEY ("tipstaffRecordPoliceForceID");


--
-- TOC entry 4045 (class 2606 OID 66079)
-- Name: TipstaffRecordSolicitors TipstaffRecordSolicitors_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."TipstaffRecordSolicitors"
    ADD CONSTRAINT "TipstaffRecordSolicitors_pkey" PRIMARY KEY ("tipstaffRecordID", "solicitorID");


--
-- TOC entry 4043 (class 2606 OID 66051)
-- Name: TipstaffRecords TipstaffRecords_pkey; Type: CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."TipstaffRecords"
    ADD CONSTRAINT "TipstaffRecords_pkey" PRIMARY KEY ("tipstaffRecordID");


--
-- TOC entry 4047 (class 2606 OID 66086)
...
--
-- TOC entry 4050 (class 1259 OID 121688)
-- Name: Passports_IX_countryID; Type: INDEX; Schema: dbo; Owner: dbadmin
--

CREATE INDEX "Passports_IX_countryID" ON dbo."Passports" USING btree ("countryID");


--
-- TOC entry 4051 (class 1259 OID 121690)
-- Name: Passports_IX_documentStatusID; Type: INDEX; Schema: dbo; Owner: dbadmin
--

CREATE INDEX "Passports_IX_documentStatusID" ON dbo."Passports" USING btree ("documentStatusID");


--
-- TOC entry 4052 (class 1259 OID 121689)
-- Name: Passports_IX_nationalityID; Type: INDEX; Schema: dbo; Owner: dbadmin
--

CREATE INDEX "Passports_IX_nationalityID" ON dbo."Passports" USING btree ("nationalityID");


--
-- TOC entry 4053 (class 1259 OID 121691)
-- Name: Passports_IX_templateID; Type: INDEX; Schema: dbo; Owner: dbadmin
--

CREATE INDEX "Passports_IX_templateID" ON dbo."Passports" USING btree ("templateID");


--
-- TOC entry 4054 (class 1259 OID 121692)
-- Name: Passports_IX_tipstaffRecordID; Type: INDEX; Schema: dbo; Owner: dbadmin
--

CREATE INDEX "Passports_IX_tipstaffRecordID" ON dbo."Passports" USING btree ("tipstaffRecordID");


--
-- TOC entry 4055 (class 2606 OID 121694)
-- Name: Passports FK_dbo.Passports_dbo.Countries_countryID; Type: FK CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "FK_dbo.Passports_dbo.Countries_countryID" FOREIGN KEY ("countryID") REFERENCES dbo."Countries"("countryID");


--
-- TOC entry 4056 (class 2606 OID 121699)
-- Name: Passports FK_dbo.Passports_dbo.DocumentStatus_documentStatusID; Type: FK CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "FK_dbo.Passports_dbo.DocumentStatus_documentStatusID" FOREIGN KEY ("documentStatusID") REFERENCES dbo."DocumentStatus"("DocumentStatusID") ON DELETE CASCADE;


--
-- TOC entry 4057 (class 2606 OID 121709)
-- Name: Passports FK_dbo.Passports_dbo.Nationalities_nationalityID; Type: FK CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "FK_dbo.Passports_dbo.Nationalities_nationalityID" FOREIGN KEY ("nationalityID") REFERENCES dbo."Nationalities"("nationalityID") ON DELETE CASCADE;


--
-- TOC entry 4058 (class 2606 OID 121714)
-- Name: Passports FK_dbo.Passports_dbo.Templates_templateID; Type: FK CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "FK_dbo.Passports_dbo.Templates_templateID" FOREIGN KEY ("templateID") REFERENCES dbo."Templates"("templateID");


--
-- TOC entry 4059 (class 2606 OID 121719)
-- Name: Passports FK_dbo.Passports_dbo.TipstaffRecords_tipstaffRecordID; Type: FK CONSTRAINT; Schema: dbo; Owner: dbadmin
--

ALTER TABLE ONLY dbo."Passports"
    ADD CONSTRAINT "FK_dbo.Passports_dbo.TipstaffRecords_tipstaffRecordID" FOREIGN KEY ("tipstaffRecordID") REFERENCES dbo."TipstaffRecords"("tipstaffRecordID") ON DELETE CASCADE;
...
-- Completed on 2023-01-25 12:33:10 GMT
