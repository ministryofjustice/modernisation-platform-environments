...
resource "aws_iam_role" "ecs_task_execution_role" {
  name               = "${local.component_name}-WorldTaskExecutionRole"
...
resource "aws_iam_policy" "ecs_secrets_policy" {
  name   = "${local.component_name}-ecs_secrets_policy"
  policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_policy" "soa_s3_policy" {
  name        = "${local.component_name}-s3-policy"
  description = "${local.component_name} s3-policy"
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "arn:aws:s3:::${local.component_name}.inbound_s3_bucket_name}/*",
                "arn:aws:s3:::${local.component_name}.inbound_s3_bucket_name",
                "arn:aws:s3:::${local.component_name}.outbound_s3_bucket_name}/*",
                "arn:aws:s3:::${local.component_name}.outbound_s3_bucket_name"
            ]
        }
    ]
...
resource "aws_iam_policy" "soa_s3_policy_cortex_deps" {
  ...
  name        = "${local.component_name}-s3-policy-cortex-deps"
  description = "${local.component_name} s3-policy-cortex-deps"
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "arn:aws:s3:::${local.component_name}.cortex_deps_bucket_name}/*",
                "arn:aws:s3:::${local.component_name}.cortex_deps_bucket_name"
            ]
        }
    ]
...
resource "aws_iam_instance_profile" "ec2_instance_profile" {
  name = "${local.component_name}-ec2-instance-profile"
  role = aws_iam_role.ec2_instance_role.name
}

resource "aws_iam_role" "ec2_instance_role" {
  name = "${local.component_name}-ec2-instance-role"
...
resource "aws_iam_policy" "ec2_instance_policy" {
  name = "${local.component_name}-ec2-instance-policy"
