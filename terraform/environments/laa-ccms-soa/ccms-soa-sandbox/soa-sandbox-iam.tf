...
resource "aws_iam_role" "ecs_task_execution_role" {
  name               = "${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].app_name}-WorldTaskExecutionRole"
...
resource "aws_iam_policy" "ecs_secrets_policy" {
  name   = "${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].app_name}-ecs_secrets_policy"
  policy = <<EOF
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_policy" "soa_s3_policy" {
  name        = "${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].app_name}-s3-policy"
  description = "${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].app_name} s3-policy"
    ...
    "Statement": [
        {
            ...
            "Resource": [
                "arn:aws:s3:::${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].inbound_s3_bucket_name}/*",
                "arn:aws:s3:::${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].inbound_s3_bucket_name}",
                "arn:aws:s3:::${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].outbound_s3_bucket_name}/*",
                "arn:aws:s3:::${local.application_data.accounts[local.environment].local.application_data.accounts[local.component_name].outbound_s3_bucket_name}"
            ]
        }
    ]
