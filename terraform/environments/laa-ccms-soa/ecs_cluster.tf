...
resource "aws_ecs_task_definition" "admin" {
  ...
  container_definitions = templatefile(
    "${path.module}/templates/task_definition_admin.json.tpl",
    {
      ...
      soa_rds_admin_user_password           = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:admin_server_password::"
      soa_rds_all_ccmssoa_schema_password   = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:soa_rds_all_ccmssoa_schema_password::"
      admin_server_password                 = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:admin_server_password::"
      edrms_xxsoa_user_password             = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:edrms_xxsoa_user_password::"
      ccms_apps_user_password               = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:ccms_apps_user_password::"
      cwa_apps_user_password                = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:cwa_apps_user_password::"
      soa_realm_pui_user_password           = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:soa_realm_pui_user_password::"
      soa_realm_apply_user_password         = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:soa_realm_apply_user_password::"
      soa_realm_caab_user_password          = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:soa_realm_caab_user_password::"
      soa_realm_ebs_soa_super_user_password = "${data.aws_secretsmanager_secret_version.soa_secrets.secret_arn}:soa_realm_ebs_soa_super_user_password::"
