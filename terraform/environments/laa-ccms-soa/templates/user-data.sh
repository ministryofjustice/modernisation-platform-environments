...
yum install git -y
su ec2-user bash -c 'aws secretsmanager get-secret-value --secret-id soa-secrets --query SecretString   --output text --region eu-west-2| jq -r ".\"deploy-github-ssh-key\""|base64 -d > /home/ec2-user/.ssh/id_rsa'
