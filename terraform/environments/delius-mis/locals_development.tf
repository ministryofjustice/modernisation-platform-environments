...
locals {
  ...
  datasync_config_dev = {
    ...
    schedule_expression        = "cron(30 11 * * ? *)"                                # Uncomment to run DataSync at 09:30 UTC (10:30 BST)
    lambda_schedule_expression = "cron(25 11 * * ? *)"                                # Uncomment to run Lambda at 09:15 UTC (10:15 BST)
