...
sed -i 's/cwa.${var.application_data.accounts[local.environment].old_domain_name}/${resource.aws_route53_record.internal.name}/g' /CWA/app/appl/admin/CWA_cwa-app2.xml
