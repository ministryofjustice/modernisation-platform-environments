...
resource "aws_vpc_security_group_ingress_rule" "hub_20_ssh" {
  referenced_security_group_id = var.application_data.accounts[local.environment].hub20_cwa_lambda_sg
  security_group_id            = aws_security_group.cwa_poc2_database.id
