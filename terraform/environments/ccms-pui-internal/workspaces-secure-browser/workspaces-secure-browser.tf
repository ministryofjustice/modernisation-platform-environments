    ...
    "chromePolicies" = {
      "ManagedBookmarks" = {
        "value" = [
          {
            "name" = "PUI"
            "url"  = "https://production-provider-ui-internal-laa-ccms-prod.apps.live.cloud-platform.service.justice.gov.uk/civil"
          },
          {
            "name" = "OPG Hub"
            "url"  = "https://production-opa-hub-laa-ccms-prod.apps.live.cloud-platform.service.justice.gov.uk/opa/web-determinations"
          }
        ]
      }
      "BookmarkBarEnabled" = {
      ...
      "URLAllowlist" = {
        "value" = [
          ...
          "production-provider-ui-internal-laa-ccms-prod.apps.live.cloud-platform.service.justice.gov.uk",
          "production-opa-hub-laa-ccms-prod.apps.live.cloud-platform.service.justice.gov.uk",
          "chrome://new-tab-page",
