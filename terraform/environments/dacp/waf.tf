...
resource "aws_wafv2_web_acl_logging_configuration" "dacp_waf_logging" {
  log_destination_configs = [aws_cloudwatch_log_group.dacp_waf_logs.arn]
  resource_arn            = aws_wafv2_web_acl.dacp_web_acl.arn
}
