...
aws rds modify-db-instance --db-instance-identifier dacp --vpc-security-group-ids sg-08244ba362f922899 sg-02473051681dba853 ${RDS_SECURITY_GROUP} --profile dts-legacy-apps-user