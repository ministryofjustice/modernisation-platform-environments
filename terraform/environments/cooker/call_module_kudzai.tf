  ...
  ec2_var = {
    ...
    ec2_complete = {
      ...
      complete-example-1 = { # The first ec2.
        ...
        ami_name          = "RHEL-9.4.0_HVM-20240605-x86_64-82-Hourly2-GP3" # Note the module requires the AMI name, not the ID.
...
module "ec2_complete_instance" {
  source = "/Users/kudzai.mtoko/mojgithub/modernisation-platform-terraform-ec2-instance" # v2.4.1
