...
locals {
  ...
  cidr_analytics        = local.environment == "development" ? ["10.26.128.0/23"] : local.environment == "production" ? ["10.27.128.0/23"] : [] # Request from Harish on behalf of Siva, connection from Analytics Platform
