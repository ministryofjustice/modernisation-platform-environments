...
locals {
  ...
  snapshot_id_xvdj_db = local.block_device_mapping_xvdj_db[5].ebs.snapshot_id
  ...
  snapshot_id_xvdk_db = local.block_device_mapping_xvdk_db[6].ebs.snapshot_id
  ...
  snapshot_id_xvdl_db = local.block_device_mapping_xvdl_db[7].ebs.snapshot_id
  ...
  snapshot_id_xvdm_db = local.block_device_mapping_xvdm_db[8].ebs.snapshot_id
  ...
  snapshot_id_xvdn_db = local.block_device_mapping_xvdn_db[9].ebs.snapshot_id
