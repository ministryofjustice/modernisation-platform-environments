  ...
  preproduction_config = {
    ...
    baseline_ec2_instances = {
      ...
      pp-csr-a-2-b = {
        ...
        tags = {
          description = "copy of PPCAW00002 for csr ${local.environment}"
          os-type     = "Windows"
          ami         = "pp-csr-a-2-b"
          component   = "app"
        }
      ...
      pp-csr-w-3-a = {
        ...
        tags = {
          description = "copy of pp-csr-w-3-a for csr ${local.environment}"
          os-type     = "Windows"
          ami         = "pp-csr-w-3-a"
          component   = "web"
        }
      ...
      pp-csr-a-18-b = {
        ...
        tags = {
          description = "copy of PPCAW00018 for csr ${local.environment}"
          os-type     = "Windows"
          ami         = "pp-csr-a-18-b"
          component   = "app"
        }
      ...
      pp-csr-a-3-a = {
        ...
        tags = {
          description = "copy of PPCAW00003 for csr ${local.environment}"
          os-type     = "Windows"
          ami         = "pp-csr-a-3-a"
          component   = "app"
        }
      ...
      pp-csr-w-4-b = {
        ...
        tags = {
          description = "copy of pp-csr-w-4-b for csr ${local.environment}"
          os-type     = "Windows"
          ami         = "pp-csr-w-4-b"
          component   = "web"
        }
