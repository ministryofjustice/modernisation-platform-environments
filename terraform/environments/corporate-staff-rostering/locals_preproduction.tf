    ...
    baseline_route53_zones = {
      "pp.csr.service.justice.gov.uk" = {
        records = [
          ...
          { name = "r3a", type = "CNAME", ttl = "300", records = "pp-csr-a-17-a.corporate-staff-rostering.hmpps-preproduction.modernisation-platform.service.justice.gov.uk" },
          { name = "r3w", type = "CNAME", ttl = "300", records = "pp-csr-w-5-a.corporate-staff-rostering.hmpps-preproduction.modernisation-platform.service.justice.gov.uk" }
        ]
      }
    }
  }
