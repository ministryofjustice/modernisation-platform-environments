locals {
  ...
  function_uri = var.function_tag ? var.function_tag : "${var.function_name}-${var.production_dev}"
}
...
resource "aws_lambda_function" "this" {
  ...
  # Image config
  image_uri    = var.is_image ? "${var.core_shared_services_id}.dkr.ecr.eu-west-2.amazonaws.com/${var.ecr_repo_name}:${var.function_name}-${var.production_dev}" : null
