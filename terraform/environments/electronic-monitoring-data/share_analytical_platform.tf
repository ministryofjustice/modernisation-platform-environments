locals {
  ...
  prod_dbs_to_grant      = local.is-production ? ["am_stg", "cap_dw_stg", "emd_historic_int", "historic_api_mart", "historic_api_mart_mock", "historic_ears_and_sars_int", "historic_ears_and_sars_mart"] : []
