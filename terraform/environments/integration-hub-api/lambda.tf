module "lambda_upload_ticket" {
  ...
  environment_variables = {
    ...
    UPLOAD_BUCKET_KMS_KEY_ARN         = data.terraform_remote_state.managed_file_transfer.outputs.upload_bucket_kms_key_arn
    UPLOAD_BUCKET_NAME                = data.terraform_remote_state.managed_file_transfer.outputs.upload_bucket_name
  }
  ...
  policy_statements = {
    ...
    upload_bucket_write = {
      ...
      resources = [
        "${data.terraform_remote_state.managed_file_transfer.outputs.upload_bucket_arn}/*",
      ]
    }
    upload_bucket_kms_access = {
      ...
      resources = [
        data.terraform_remote_state.managed_file_transfer.outputs.upload_bucket_kms_key_arn,
      ]
    }
  }
