locals {
  ...
  #### OLD RULES - TO BE REMOVED AFTER PROD CUTOVER ####
    ...
    private_lb = {
      ...
      ingress = {
        ...
        https = {
          ...
          protocol    = "tcp"
          cidr_blocks = flatten([
            local.security_group_cidrs_old.https_internal,
          ])
        }
      }
      egress = {
    ...
    public_lb = {
      ...
      ingress = {
        ...
        https = {
          ...
          protocol    = "tcp"
          cidr_blocks = flatten([
            local.security_group_cidrs_old.https_external_1,
            local.security_group_cidrs_old.https_external_monitoring,
          ])
        }
      }
      egress = {
    ...
    public_lb_2 = {
      ...
      ingress = {
        ...
        https = {
          ...
          protocol    = "tcp"
          cidr_blocks = flatten([
            local.security_group_cidrs_old.https_external_2,
          ])
        }
      }
      egress = {
    ...
    private_web = {
      ...
      ingress = {
        ...
        http8080 = {
          ...
          to_port         = 8080
          protocol        = "tcp"
          cidr_blocks     = local.security_group_cidrs_old.https_internal
          security_groups = ["private_lb", "public_lb", "public_lb_2"]
        }
      }
      egress = {
    ...
    data = {
      ...
      ingress = {
        ...
        icmp = {
          ...
          to_port     = -1
          protocol    = "icmp"
          cidr_blocks = local.security_group_cidrs_old.icmp
        }
        ssh = {
          ...
          to_port         = "22"
          protocol        = "TCP"
          cidr_blocks     = local.security_group_cidrs_old.ssh
          security_groups = []
        }
        http8080 = {
          description = "Allow http 8080 ingress"
        ...
        oracle3872 = {
          ...
          to_port     = "3872"
          protocol    = "TCP"
          cidr_blocks = local.security_group_cidrs_old.oracle_oem_agent
        }
      }
      egress = {
        all = {
