  ...
  test_config = {
    ...
    baseline_acm_certificates = {
      "${local.application_name}_wildcard_cert" = {
        ...
        cloudwatch_metric_alarms            = {} # module.baseline_presets.cloudwatch_metric_alarms_lists_with_actions["dso"].acm_default        cloudwatch_metric_alarms            = module.baseline_presets.cloudwatch_metric_alarms_lists_with_actions["dso_pagerduty"].acm_default
        tags = {
