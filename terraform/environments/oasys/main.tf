...
module "baseline" {
  ...
  acm_certificates       = module.baseline_presets.acm_certificates # merge(module.baseline_presets.acm_certificates, lookup(local.environment_config, "baseline_acm_certificates", {}))
