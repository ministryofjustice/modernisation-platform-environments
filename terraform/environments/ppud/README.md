...
<!-- Adding the last date this page was reviewed, with any accompanying information -->  24/07/2023

### **Description:**

Terraform Infrastructure as code that creates 3 AWS environments for the PPUD application: Development, PreProduction, and Production, including AWS SES, Directory service, SNS, SSM, Lambda, Event Brdige, cloudwatch and secret manager.
