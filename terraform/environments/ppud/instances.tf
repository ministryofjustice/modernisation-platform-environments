...
resource "aws_instance" "s609693lo6vw102" {
  ...
  source_dest_check      = true
  iam_instance_profile   = aws_iam_instance_profile.ec2_profile.id
  vpc_security_group_ids = [aws_security_group.conditional["Document-Service-Server-Security-Group"].id]
  subnet_id              = data.aws_subnet.private_subnets_c.id
...
resource "aws_instance" "s609693lo6vw104" {
  ...
  source_dest_check      = true
  iam_instance_profile   = aws_iam_instance_profile.ec2_profile.id
  vpc_security_group_ids = [aws_security_group.conditional["WAM-Data-Access-Server-Security-Group"].id]
  subnet_id              = data.aws_subnet.private_subnets_a.id
...
resource "aws_instance" "s609693lo6vw105" {
  ...
  source_dest_check      = true
  iam_instance_profile   = aws_iam_instance_profile.ec2_profile.id
  vpc_security_group_ids = [aws_security_group.conditional["WAM-Web-Portal-Server-Security-Group"].id]
  subnet_id              = data.aws_subnet.private_subnets_a.id
