...
resource "aws_ssm_association" "ad_join_domain_association_preprod" {
  ...
  depends_on = [aws_instance.s618358rgvw201, aws_instance.S618358RGVW202, aws_instance.s618358rgsw025, aws_instance.s618358rgvw024, aws_instance.s618358rgvw023, aws_instance.s618358rgvw026, aws_instance.s618358rgvw028, aws_instance.s618358rgvw029]
  name       = aws_ssm_document.api_ad_join_domain.name
  targets {
    key    = "InstanceIds"
    values = [aws_instance.s618358rgvw201[0].id, aws_instance.S618358RGVW202[0].id, aws_instance.s618358rgsw025[0].id, aws_instance.s618358rgvw024[0].id, aws_instance.s618358rgvw023[0].id, aws_instance.s618358rgvw026[0].id, aws_instance.s618358rgvw028[0].id, aws_instance.s618358rgvw029[0].id]
  }
}
...
resource "aws_ssm_association" "ad_join_domain_association_prod" {
  ...
  depends_on = [aws_instance.s618358rgvw019, aws_instance.s618358rgvw020, aws_instance.s618358rgvw021, aws_instance.s618358rgvw022, aws_instance.s618358rgvw027, aws_instance.s618358rgvw030, aws_instance.s618358rgvw031, aws_instance.s618358rgvw032, aws_instance.s618358rgvw204, aws_instance.s618358rgvw205, aws_instance.s618358rgsw025p]
  name       = aws_ssm_document.api_ad_join_domain.name
  targets {
    key    = "InstanceIds"
    values = [aws_instance.s618358rgvw019[0].id, aws_instance.s618358rgvw020[0].id, aws_instance.s618358rgvw021[0].id, aws_instance.s618358rgvw022[0].id, aws_instance.s618358rgvw027[0].id, aws_instance.s618358rgvw030[0].id, aws_instance.s618358rgvw031[0].id, aws_instance.s618358rgvw032[0].id, aws_instance.s618358rgvw204[0].id, aws_instance.s618358rgvw205[0].id, aws_instance.s618358rgsw025p[0].id]
  }
}
