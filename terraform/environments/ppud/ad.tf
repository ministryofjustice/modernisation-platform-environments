...
resource "aws_ssm_association" "ad_join_domain_association_prod" {
  ...
  depends_on = [aws_instance.s618358rgvw019, aws_instance.s618358rgvw020, aws_instance.s618358rgvw021, aws_instance.s618358rgvw022, aws_instance.s618358rgvw027, aws_instance.s618358rgvw204, aws_instance.s618358rgvw205, aws_instance.s618358rgsw025p, aws_instance.s618358test]
  name       = aws_ssm_document.api_ad_join_domain.name
  targets {
    key    = "InstanceIds"
