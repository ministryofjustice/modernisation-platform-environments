...
locals {
  lambda_function_arns = {
    ...
    send_cpu_graph                 = local.is-production ? aws_lambda_function.send_cpu_graph_production[0].arn : null
    ...
    ppud_elb_daily_trt_graph       = local.is-production ? aws_lambda_function.ppud_elb_graph_trt_data_production[0].arn : null
    wam_elb_daily_trt_graph        = local.is-production ? aws_lambda_function.wam_elb_graph_trt_data_production[0].arn : null
