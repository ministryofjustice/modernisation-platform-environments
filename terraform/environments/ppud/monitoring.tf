...
resource "aws_cloudwatch_metric_alarm" "ddos_attack_external" {
  ...
  alarm_actions       = [aws_sns_topic.ppudprod_high_priority.arn]
  dimensions = {
...
resource "aws_sns_topic" "ppudprod_high_priority" {
  name              = "ppudprod_high_priority"
