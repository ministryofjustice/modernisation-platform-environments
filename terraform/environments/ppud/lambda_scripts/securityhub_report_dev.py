...
SUBJECT = f'AWS Security Hub - Development Critical Vulnerabilities - {CURRENT_DATE}'
...
def format_findings(findings):
    ...
    <body>
      <p>Hi Team</p>
      <p></p>
      <p>Please find below the current AWS Development Security Hub Critical Vulnerabilities.</p>
