...
module "waf" {
  ...
  source = "git::https://github.com/ministryofjustice/modernisation-platform-terraform-aws-waf?ref=988bd00146a11718ddba7ab8468ac17839447c59"
  enable_ddos_protection   = true
  ddos_rate_limit          = 150
  block_non_uk_traffic     = true
  blocked_ip_rule_priority = 20
