...
# S3 Bucket for Patch Manager / SSM Health Check Reports
  ...
  #tfsec:ignore:Bucket-does-not-have-encryption-enabled "S3 bucket is not public facing, does not contain any sensitive information and does not need encryption."
