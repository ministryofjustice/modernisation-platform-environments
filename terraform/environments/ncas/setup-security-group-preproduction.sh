...
aws rds modify-db-instance --db-instance-identifier postgresql-11-staging --vpc-security-group-ids sg-08244ba362f922899 sg-0e0f5cf0883f81945 sg-05ea046c ${RDS_SECURITY_GROUP} --profile dts-legacy-apps-user
