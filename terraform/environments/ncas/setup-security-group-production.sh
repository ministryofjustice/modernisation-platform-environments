...
aws rds modify-db-instance --db-instance-identifier ncas --vpc-security-group-ids sg-05ea046c sg-08244ba362f922899 ${RDS_SECURITY_GROUP} --profile dts-legacy-apps-user