...
resource "aws_cloudwatch_log_group" "ncas_waf_logs" {
...
resource "aws_wafv2_web_acl_logging_configuration" "ncas_waf_logging" {
  log_destination_configs = [aws_cloudwatch_log_group.ncas_waf_logs.arn]
  resource_arn            = aws_wafv2_web_acl.ncas_web_acl.arn
}