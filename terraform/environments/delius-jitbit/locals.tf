locals {
  ...
  # acm_subject_alternative_names = local.is-development ? [local.app_url, "blue-${local.app_url}", "green-${local.app_url}", local.sandbox_app_url, "blue-${local.sandbox_app_url}", "green-${local.sandbox_app_url}"] : [local.app_url, "blue-${local.app_url}", "green-${local.app_url}"]
  ...
  # domain_name_sub_blue            = [for k, v in local.domain_types : v.name if k == "blue-${local.app_url}"]
  # domain_name_sub_green           = [for k, v in local.domain_types : v.name if k == "green-${local.app_url}"]
  ...
  # domain_record_sub_blue          = [for k, v in local.domain_types : v.name if k == "blue-${local.app_url}"]
  # domain_record_sub_green         = [for k, v in local.domain_types : v.name if k == "green-${local.app_url}"]
  # domain_record_sub_sandbox       = [for k, v in local.domain_types : v.record if k == local.sandbox_app_url]
  # domain_record_sub_sandbox_blue  = [for k, v in local.domain_types : v.name if k == "blue-${local.sandbox_app_url}"]
  # domain_record_sub_sandbox_green = [for k, v in local.domain_types : v.name if k == "green-${local.sandbox_app_url}"]
  ...
  # domain_type_sub_blue            = [for k, v in local.domain_types : v.type if k == "blue-${local.app_url}"]
  # domain_type_sub_green           = [for k, v in local.domain_types : v.type if k == "green-${local.app_url}"]
