...
resource "aws_vpc_security_group_egress_rule" "oem_app_efs_sg_egress_tcp_443_443_cidr" {
  security_group_id = aws_security_group.oem_app_efs_sg.id
...
resource "aws_vpc_security_group_ingress_rule" "oem_app_efs_sg_ingress_tcp_2049_2049_cidr" {
  security_group_id = aws_security_group.oem_app_efs_sg.id
