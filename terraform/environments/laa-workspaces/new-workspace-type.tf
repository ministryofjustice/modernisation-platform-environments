...
###
### Bundle specs (Windows 10 on Server 2019):
...
locals {
  workspace_types = {
    standard = {
      bundle_id                                 = "wsb-6cbvhvv9f"  # Standard with Windows 10
      running_mode                              = "AUTO_STOP"
      running_mode_auto_stop_timeout_in_minutes = 60
    }
    performance = {
      bundle_id                                 = "wsb-55rrhyyg1"  # Performance with Windows 10
      running_mode                              = "AUTO_STOP"
      running_mode_auto_stop_timeout_in_minutes = 60
    }
    power = {
      bundle_id                                 = "wsb-g72p36ch9"  # Power with Windows 10
      running_mode                              = "AUTO_STOP"
      running_mode_auto_stop_timeout_in_minutes = 60
    }
  }
