data "aws_iam_policy_document" "transfer_service_landing_bucket_policy" {
  statement {
...
module "transfer_service_landing_bucket" {
  ...
  force_destroy = true
  attach_policy = true
  policy        = data.aws_iam_policy_document.transfer_service_landing_bucket_policy.json
