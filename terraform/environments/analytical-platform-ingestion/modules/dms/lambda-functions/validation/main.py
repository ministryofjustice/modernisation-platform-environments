...
class FileValidator:
    ...
    def execute(self):
        ...
        if self.errors:
            ...
            #  https://docs.aws.amazon.com/lambda/latest/dg/python-logging.html#python-logging-extra
            logger.error(f"{self.key} failed validation", extra={"validation_errors": self.errors})
...
def handler(event, context):  # noqa: C901 pylint: disable=unused-argument
    ...
    try:
        ...
        logger.info(f"Error creating FileValidator: {e}")
