...
resource "aws_s3_bucket" "raw_history" {
  ...
  #checkov:skip=CKV2_AWS_61:Lifecycle configuration not needed
  #checkov:skip=CKV2_AWS_62:Versioning,event notifications,logging not needed
  #checkov:skip=CKV_AWS_86:Public ACLs block not required
  #checkov:skip=CKV_AWS_87:Public ACLs block not required
  #checkov:skip=CKV_AWS_87:Bucket encryption not required
  #checkov:skip=CKV_AWS_91:Public ACLs block not required
  #checkov:skip=CKV_AWS_93:Public ACLs block not required
  #checkov:skip=CKV_AWS_132:Bucket encryption with CMK not required
  #checkov:skip=CKV_AWS_144:Cross-region replication not required
