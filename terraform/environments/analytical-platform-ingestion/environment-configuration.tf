locals {
  ...
  environment_configurations = {
    development = {
      ...
      /* Image Versions */
      scan_image_version     = "0.2.5"
      transfer_image_version = "0.0.27"
      notify_image_version   = "0.0.28"
      ...
      target_kms_keys = [
        ...
        "arn:aws:kms:eu-west-2:525294151996:key/449a6d95-2498-4345-9805-03e67302ea6e"  # s3/moj-ingestion-prefix-test
      ]
      ...
      transfer_server_sftp_users = {
        ...
        "access-uk" = {
          ...
          cidr_blocks = ["172.167.164.209/32", "51.11.29.242/32"]
        }
      }
    ...
    production = {
      ...
      /* Image Versions */
      scan_image_version     = "0.2.4"
      transfer_image_version = "0.0.26"
      notify_image_version   = "0.0.27"
      ...
      transfer_server_sftp_users = {
        ...
        "opg-restore-ocr" = {
          ssh_key     = "ssh-rsa "
