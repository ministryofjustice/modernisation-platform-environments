...
moved {
  from = aws_s3_bucket_lifecycle_configuration.cur_v2_hourly
  to   = module.cur_v2_hourly.aws_s3_bucket_lifecycle_configuration.this[0]
}

moved {
  from = aws_s3_bucket_lifecycle_configuration.focus_reports
  to   = module.focus_reports.aws_s3_bucket_lifecycle_configuration.this[0]
}

moved {
  from = aws_s3_bucket_lifecycle_configuration.coat_reports
  to   = module.coat_reports.aws_s3_bucket_lifecycle_configuration.this[0]
}

moved {
  from = aws_s3_bucket_lifecycle_configuration.cur_v2_hourly_enriched[0]
  to   = module.cur_v2_hourly_enriched[0].aws_s3_bucket_lifecycle_configuration.this[0]
}
