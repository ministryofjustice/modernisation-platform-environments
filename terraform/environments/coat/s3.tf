      ...
      principals = [
        {
          ...
          identifiers = [
            ...
            "arn:aws:iam::${local.environment_management.aws_organizations_root_account_id}:role/aws-reserved/sso.amazonaws.com/eu-west-2/AWSReservedSSO_ReadOnlyAccess_0d3d0b289cbef6c3"
          ]
        }
      ]
    },
