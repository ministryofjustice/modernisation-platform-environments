locals {
  ...
  domain_share_secret_principal_ids = {
    ...
    test = [
      ...
      "arn:aws:iam::${module.environment.account_ids.hmpps-domain-services-test}:role/ad-fixngo-ec2-live-role",
      "arn:aws:iam::${module.environment.account_ids.hmpps-domain-services-test}:role/ad-fixngo-ec2-nonlive-role",
    ]
    preproduction = []
    production = [
