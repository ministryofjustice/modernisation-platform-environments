locals {
  ...
  alerting_golden_signals = {
    ...
    litellm_provider_state            = { group = "AI Gateway", datasource_type = "prometheus", expr = "litellm_provider_health_status{container=\"litellm\",api_provider=\"bedrock\"}", metric = "litellm_provider_health_status", type = "gt", dim_key = "", ok_when_nodata = true, warning = "litellm_provider_state_warn", critical = "litellm_provider_state_crit" }
  }
}