  ...
  values = [
    templatefile(
      "${path.module}/configuration/helm/headlamp/values.yml.tftpl",
      {
        ...
        client_id            = module.headlamp_entra_id_secret.secret_string["client_id"]
        client_secret        = module.headlamp_entra_id_secret.secret_string["client_secret"]
        ...
        tenant_id            = module.headlamp_entra_id_secret.secret_string["tenant_id"]
      }
    )
  ]
}
