...
resource "aws_lambda_permission" "api_gw" {
  ...
  source_arn = "arn:aws:execute-api:${local.region}:${local.accountId}:${aws_api_gateway_rest_api.data_platform.id}/*/${aws_api_gateway_method.upload_data_get.http_method}${aws_api_gateway_resource.upload_data.path}"
}
