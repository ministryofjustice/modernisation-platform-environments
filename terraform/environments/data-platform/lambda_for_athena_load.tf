...
resource "aws_lambda_function" "athena_load" {
  ...
  image_uri                      = "${local.environment_management.account_ids["core-shared-services-production"]}.dkr.ecr.eu-west-2.amazonaws.com/data-platform-athena-load-lambda-ecr-repo:1.0.2"
  package_type                   = "Image"
