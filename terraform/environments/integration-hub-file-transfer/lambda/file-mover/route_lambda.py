...
config = Configuration.for_route()
logger = Logger(service="integration-hub-file-transfer-route")
metrics = Metrics(service="integration-hub-file-transfer-route")
...
@idempotent(
    ...
    key_prefix="managed-file-transfer/route",
)
