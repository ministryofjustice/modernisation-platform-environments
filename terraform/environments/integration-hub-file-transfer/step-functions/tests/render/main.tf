  ...
  definition = templatefile("../../file-transfer-workflow.asl.json", {
    ...
    routing_destinations = jsonencode({
      clean = {
        ...
        kmsKeyArn = "arn:aws:kms:eu-west-2:123456789012:key/22345678-1234-1234-1234-123456789012"
      }
      quarantine = {
        bucket    = "integration-hub-file-transfer-development-quarantine"
        kmsKeyArn = "arn:aws:kms:eu-west-2:123456789012:key/32345678-1234-1234-1234-123456789012"
      }
      investigation = {
        bucket    = "integration-hub-file-transfer-development-investigation"
        kmsKeyArn = "arn:aws:kms:eu-west-2:123456789012:key/42345678-1234-1234-1234-123456789012"
      }
    })
