module "iam_policy_guardduty_s3" {
  ...
  policy = data.aws_iam_policy_document.guardduty_s3_permissions.json
...
module "iam_role_guardduty_s3" {
  ...
  policies = {
    guardduty_s3_plan = module.iam_policy_guardduty_s3.arn
  }

  tags = local.tags
}

data "aws_iam_policy_document" "guardduty_s3_permissions" {
