locals {
  ...
  cloudwatch_log_metric_filters = {
    "custom-idp-authentication-failures" = {
      log_group_name                  = "/aws/lambda/${module.lambda_custom_idp.lambda_function_name}"
      metric_transformation_name      = "CustomIdPAuthenticationFailures"
      metric_transformation_namespace = "IntegrationHubFileTransfer"
      pattern                         = "\"Authentication failed:\""
    }
    "custom-idp-unexpected-errors" = {
      log_group_name                  = "/aws/lambda/${module.lambda_custom_idp.lambda_function_name}"
      metric_transformation_name      = "CustomIdPUnexpectedErrors"
      metric_transformation_namespace = "IntegrationHubFileTransfer"
      pattern                         = "\"Unexpected custom IdP error\""
    }
  }

  cloudwatch_metric_alarms = merge({
    "custom-idp-authentication-failures" = {
      alarm_description   = "The custom IdP has rejected five or more authentication attempts"
      comparison_operator = "GreaterThanOrEqualToThreshold"
      dimensions          = {}
      evaluation_periods  = 1
      metric_name         = "CustomIdPAuthenticationFailures"
      namespace           = "IntegrationHubFileTransfer"
      period              = 300
      statistic           = "Sum"
      threshold           = 5
    }
    "custom-idp-unexpected-errors" = {
      alarm_description   = "The custom IdP Lambda function encountered an unexpected error"
      comparison_operator = "GreaterThanThreshold"
      dimensions          = {}
      evaluation_periods  = 1
      metric_name         = "CustomIdPUnexpectedErrors"
      namespace           = "IntegrationHubFileTransfer"
      period              = 300
      statistic           = "Sum"
      threshold           = 0
    ...
    "lambda-custom-idp-duration" = {
      alarm_description   = "The custom IdP Lambda function duration is approaching its timeout"
      comparison_operator = "GreaterThanThreshold"
    ...
    "lambda-custom-idp-throttles" = {
      alarm_description   = "The custom IdP Lambda function has been throttled"
      comparison_operator = "GreaterThanThreshold"
      dimensions = {
        FunctionName = module.lambda_custom_idp.lambda_function_name
      }
    ...
    "transfer-authentication-failures" = {
      alarm_description   = "The Transfer Family server has recorded five or more failed connections"
      comparison_operator = "GreaterThanOrEqualToThreshold"
      dimensions = {
