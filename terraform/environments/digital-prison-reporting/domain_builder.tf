...
module "domain_builder_cli_agent" {
  ...
  env_vars = {
    #  DOMAIN_API_KEY = module.domain_builder_api_key[0].secret != null ? module.domain_builder_api_key[0].secret : ""
    #  REST_API_EXEC_ARN = module.domain_builder_api_gateway[0].rest_api_execution_arn != null ? module.domain_builder_api_gateway[0].rest_api_execution_arn : ""
    #  REST_API_ID = module.domain_builder_api_gateway[0].rest_api_id != null ? module.domain_builder_api_gateway[0].rest_api_id : ""
