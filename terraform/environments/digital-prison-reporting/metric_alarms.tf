...
module "dpr_redshift_health_status_check" {
  ...
  create_metric_alarm = local.enable_redshift_health_check
...
module "dpr_dms_stoptask_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_stop_check
...
module "dpr_dms_starttask_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_start_check
...
module "dpr_dms_cpu_utils_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_cpu_check
...
module "dpr_dms_free_memory_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_freemem_check
...
module "dpr_dms_freeable_memory_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_freeablemem_check
...
module "dpr_dms_swap_usage_check" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_swapusage_check
...
module "dpr_dms_network_transmit_throughput" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_network_trans_tp_check
...
module "dpr_dms_network_receive_throughput" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_network_rec_tp_check
...
module "dpr_dms_cdc_source_latency" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_cdc_src_lat_check
...
module "dpr_dms_cdc_target_latency" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_cdc_targ_lat_check
...
module "dpr_dms_cdc_incoming_events" {
  source              = "./modules/cw_alarm"
  create_metric_alarm = local.enable_dms_cdc_inc_events_check
