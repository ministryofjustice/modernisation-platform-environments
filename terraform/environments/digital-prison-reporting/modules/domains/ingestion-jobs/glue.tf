...
module "glue_reporting_hub_cdc_job" {
  ...
  glue_cdc_job_spark_broadcast_timeout_seconds       = var.glue_cdc_job_spark_broadcast_timeout_seconds
  glue_cdc_job_disable_auto_broadcast_join_threshold = var.glue_cdc_job_disable_auto_broadcast_join_threshold
