...
module "postgres-tickle-lambda-testing" {
  ...
  lambda_code_s3_key           = "s3://dpr-artifact-store-development/build-artifacts/dev-sandbox/digital-prison-reporting-lambdas/jars/digital-prison-reporting-lambdas-vLatest-all.jar"
