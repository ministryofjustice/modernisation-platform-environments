...
select j.*, s.[description] as subcategory, s.[id] as subcatid, c.[description] as category, c.num as catid,
	s2.[description] as secsubcategory, s2.[id] as secsubcatid, c2.[description] as seccategory, c2.num as seccatid,
	j.file_no_1 + '-' + j.file_no_3 + '-' + j.file_no_2  as 'filenumber'
from judgment j
inner join subcategory s on j.main_subcategory_id = s.id
inner join category c on s.parent_num = c.num
left join subcategory s2 on j.sec_subcategory_id = s2.id
...
USE [Lands]
GO
/****** Object:  Table [dbo].[COMMISSIONER]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY_CACHE_STATUS]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[JUDGMENT_HOME_SEARCH_STATUS]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JUDGMENT]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Users]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[SUBCATEGORY]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[COMMISSIONERJUDGMENTMAP]    Script Date: 09/26/2024 09:29:25 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Check [chk_ccs_pk]    Script Date: 09/26/2024 09:29:25 ******/
...
GO
/****** Object:  Check [CK__JUDGMENT__is_pub__77BFCB91]    Script Date: 09/26/2024 09:29:25 ******/
ALTER TABLE [dbo].[JUDGMENT]  WITH CHECK ADD CHECK  (([is_published] = 1 or [is_published] = 0))
GO
/****** Object:  Check [chk_pk]    Script Date: 09/26/2024 09:29:25 ******/
...
GO
/****** Object:  ForeignKey [FK__COMMISSIO__commi__7D78A4E7]    Script Date: 09/26/2024 09:29:25 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([commissioner_id])
REFERENCES [dbo].[COMMISSIONER] ([id])
GO
/****** Object:  ForeignKey [FK__COMMISSIO__judgm__7C8480AE]    Script Date: 09/26/2024 09:29:25 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([judgment_id])
REFERENCES [dbo].[JUDGMENT] ([id])
GO
/****** Object:  ForeignKey [subcategory_fk]    Script Date: 09/26/2024 09:29:25 ******/
