...
USE [Ossc]
GO
/****** Object:  Table [dbo].[COMMISSIONER]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY_CACHE_STATUS]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[JUDGMENT_HOME_SEARCH_STATUS]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[SUBCATEGORY]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[JUDGMENT]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
CREATE TABLE [dbo].[JUDGMENT](
	...
	[ncn_year] [int] NULL,
	[ncn_code1] [varchar](20) NULL,
	[ncn_citation] [int] NULL,
	[ncn_code2] [varchar](20) NULL,
PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX  = OFF, STATISTICS_NORECOMPUTE  = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS  = ON, ALLOW_PAGE_LOCKS  = ON) ON [PRIMARY]
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[COMMISSIONERJUDGMENTMAP]    Script Date: 09/26/2024 09:23:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Check [chk_ccs_pk]    Script Date: 09/26/2024 09:23:52 ******/
...
GO
/****** Object:  Check [CK__JUDGMENT__is_pub__77BFCB91]    Script Date: 09/26/2024 09:23:52 ******/
ALTER TABLE [dbo].[JUDGMENT]  WITH CHECK ADD CHECK  (([is_published] = 1 or [is_published] = 0))
GO
/****** Object:  Check [chk_pk]    Script Date: 09/26/2024 09:23:52 ******/
...
GO
/****** Object:  ForeignKey [FK__COMMISSIO__commi__00551192]    Script Date: 09/26/2024 09:23:52 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([commissioner_id])
REFERENCES [dbo].[COMMISSIONER] ([id])
GO
/****** Object:  ForeignKey [FK__COMMISSIO__judgm__7F60ED59]    Script Date: 09/26/2024 09:23:52 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([judgment_id])
REFERENCES [dbo].[JUDGMENT] ([id])
GO
/****** Object:  ForeignKey [judgment_subcat_fk1]    Script Date: 09/26/2024 09:23:52 ******/
ALTER TABLE [dbo].[JUDGMENT]  WITH CHECK ADD  CONSTRAINT [judgment_subcat_fk1] FOREIGN KEY([main_subcategory_id])
REFERENCES [dbo].[SUBCATEGORY] ([id])
GO
ALTER TABLE [dbo].[JUDGMENT] CHECK CONSTRAINT [judgment_subcat_fk1]
GO
/****** Object:  ForeignKey [judgment_subcat_fk2]    Script Date: 09/26/2024 09:23:52 ******/
ALTER TABLE [dbo].[JUDGMENT]  WITH CHECK ADD  CONSTRAINT [judgment_subcat_fk2] FOREIGN KEY([sec_subcategory_id])
REFERENCES [dbo].[SUBCATEGORY] ([id])
GO
ALTER TABLE [dbo].[JUDGMENT] CHECK CONSTRAINT [judgment_subcat_fk2]
GO
/****** Object:  ForeignKey [subcategory_fk]    Script Date: 09/26/2024 09:23:52 ******/
