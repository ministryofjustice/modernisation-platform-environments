...
USE [IMSET]
GO
/****** Object:  Table [dbo].[COMMISSIONER]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY_CACHE_STATUS]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[CATEGORY]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[JUDGMENT_HOME_SEARCH_STATUS]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[JUDGMENT]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[Users]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[SUBCATEGORY]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING OFF
GO
/****** Object:  Table [dbo].[COMMISSIONERJUDGMENTMAP]    Script Date: 09/26/2024 09:28:14 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Check [chk_ccs_pk]    Script Date: 09/26/2024 09:28:14 ******/
...
GO
/****** Object:  Check [CK__JUDGMENT__is_pub__77BFCB91]    Script Date: 09/26/2024 09:28:14 ******/
ALTER TABLE [dbo].[JUDGMENT]  WITH CHECK ADD CHECK  (([is_published] = 1 or [is_published] = 0))
GO
/****** Object:  Check [chk_pk]    Script Date: 09/26/2024 09:28:14 ******/
...
GO
/****** Object:  ForeignKey [FK__COMMISSIO__commi__7D78A4E7]    Script Date: 09/26/2024 09:28:14 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([commissioner_id])
REFERENCES [dbo].[COMMISSIONER] ([id])
GO
/****** Object:  ForeignKey [FK__COMMISSIO__judgm__7C8480AE]    Script Date: 09/26/2024 09:28:14 ******/
ALTER TABLE [dbo].[COMMISSIONERJUDGMENTMAP]  WITH CHECK ADD FOREIGN KEY([judgment_id])
REFERENCES [dbo].[JUDGMENT] ([id])
GO
/****** Object:  ForeignKey [subcategory_fk]    Script Date: 09/26/2024 09:28:14 ******/
