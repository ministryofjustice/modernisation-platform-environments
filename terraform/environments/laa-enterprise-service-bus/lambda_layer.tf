...
resource "aws_lambda_layer_version" "oracledb_lambda_layer_python" {
  ...
  description         = "Oracle DB layer for Python"
  s3_bucket           = aws_s3_object.patch_lambda_layer_zip.bucket
  s3_key              = aws_s3_object.patch_lambda_layer_zip.key
  s3_object_version   = aws_s3_object.patch_lambda_layer_zip.version_id
