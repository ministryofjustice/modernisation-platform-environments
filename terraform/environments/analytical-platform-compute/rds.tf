...
module "ollamate_rds" {
  ...
  kms_key_id                  = module.ollamate_rds_kms.key_arn
  ...
  create_monitoring_role          = true
  monitoring_role_use_name_prefix = true
  monitoring_role_name            = "ollamate-rds-monitoring"
  monitoring_role_description     = "Enhanced Monitoring for Ollamate RDS"
  monitoring_interval             = 30
  enabled_cloudwatch_logs_exports = ["postgresql", "upgrade"]
