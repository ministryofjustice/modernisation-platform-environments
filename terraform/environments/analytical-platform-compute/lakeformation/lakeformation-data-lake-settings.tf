resource "aws_lakeformation_data_lake_settings" "london" {
  admins = [
    ...
    module.lake_formation_share_role.arn,
    # module.analytical_platform_ui_service_role.iam_role_arn,
    module.analytical_platform_data_eng_dba_service_role.arn,
    ...
    module.copy_apdp_cadet_metadata_to_compute_assumable_role.arn
  ]
}
