resource "aws_quicksight_account_subscription" "subscription" {
  ...
  admin_group                      = ["analytical-platform", "entraid-aws-identitycenter-analytical-platform"]
  author_group                     = ["analytical-platform", "entraid-aws-identitycenter-analytical-platform"]
