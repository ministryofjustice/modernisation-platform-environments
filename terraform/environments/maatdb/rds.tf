...
module "rds" {
  ...
  mlra_ecs_cluster_sec_group_id         = "${local.environment_management.account_ids["maat-${local.environment}"]}/${local.application_data.accounts[local.environment].mlra_ecs_cluster_sec_group_id}"
