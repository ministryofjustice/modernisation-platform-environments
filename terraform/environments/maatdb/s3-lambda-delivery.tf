...
resource "aws_s3_bucket" "maatdb_shared" {
...
resource "aws_s3_object" "folder" {
  bucket = aws_s3_bucket.maatdb_shared.bucket
  for_each = {
...
resource "aws_s3_bucket_public_access_block" "maatdb_shared" {
  bucket                  = aws_s3_bucket.maatdb_shared.id
...
resource "aws_s3_bucket_versioning" "maatdb_shared" {
  bucket = aws_s3_bucket.maatdb_shared.id
