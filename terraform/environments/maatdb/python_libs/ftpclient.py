...
# Resolve HOST, USER, PASSWORD, PORT and REMOTEPATH from AWS Secrets Manager when SECRET_NAME is set.
# This keeps credentials and connection details out of the Lambda console and env var plaintext.
            ...
            # Support older maatdb array format: [{"name":"xerox-outbound","type":"username","value":"user"}, ...]
                ...
                for pair in parsed:
                    ...
                    if t in ('username', 'user'):
                        ...
                        port = val
                    elif t in ('remote-folder', 'remotepath', 'remote_path', 'remote-path'):
                        remotePath = val
