...
resource "aws_db_instance" "appdb1" {
  ...
  username                              = var.username
  password                              = random_password.rds_password.result
  vpc_security_group_ids                = var.environment != "production" ? [aws_security_group.cloud_platform_sec_group.id, aws_security_group.bastion_sec_group.id, aws_security_group.vpc_sec_group.id] : [aws_security_group.cloud_platform_sec_group.id, aws_security_group.bastion_sec_group.id]
