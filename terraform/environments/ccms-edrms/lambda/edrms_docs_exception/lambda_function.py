...
class ConfigValidator:
    ...
    def validate_mandatory_fields(config_dict: Dict[str, Any], field_name: str) -> None:
        ...
        mandatory_fields = {
            "slack_channel_webhook_docs": config_dict.get("slack_channel_webhook_docs")
        }
...
class ValidateConfig:
    ...
    def __post_init__(self):
        ...
        config_dict = {
            "slack_channel_webhook_docs": self.slack_channel_webhook_docs,
        }
...
def parse_config_from_env_and_secrets(
    ...
    config = ValidateConfig(
        ...
        slack_channel_webhook_docs=ConfigValidator.get_mandatory_secret(secrets_data, "slack_channel_webhook_docs"),
...
def lambda_handler(event, context):
    ...
    try:
        ...
        required_secrets = ["slack_channel_webhook_docs"]
        ...
        notification_service = NotificationService(
            config.slack_channel_webhook_docs, context.function_name
        )
