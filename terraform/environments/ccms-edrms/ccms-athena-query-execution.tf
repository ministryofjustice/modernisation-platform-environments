...
aws athena start-query-execution \
  --query-string "$(aws athena get-named-query --named-query-id ${aws_athena_named_query.main_table_edrmsapp_internal.id} --query 'NamedQuery.QueryString' --output text)" \
