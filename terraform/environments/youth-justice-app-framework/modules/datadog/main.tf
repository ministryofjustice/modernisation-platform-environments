...
resource "aws_kinesis_firehose_delivery_stream" "to_datadog" {
  ...
  http_endpoint_configuration {
    url                = "https://http-intake.logs.datadoghq.eu/v1/input/YOUR_DATADOG_API_KEY"  # ADD DD API KEY
    name               = "Datadog"
    access_key         = ""  # Leave empty for unauthenticated; Datadog uses API key in URL
