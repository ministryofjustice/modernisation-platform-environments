...
resource "aws_cloudfront_response_headers_policy" "strict_transport_security" {
  ...
  security_headers_config {
    ...
    content_security_policy {
      override                = true
      content_security_policy = "default-src 'none'; script-src 'self' 'unsafe-inline' 'unsafe-hashes' https://public.tableau.com https://maps.googleapis.com https://maps.gstatic.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https://*.imgur.com https://maps.gstatic.com https://maps.googleapis.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://www.gov.uk https://maps.googleapis.com https://maps.gstatic.com https://*.tableau.yjbservices.yjb.gov.uk; object-src 'self' blob: https://*.yjbservices.yjb.gov.uk; frame-src 'self' blob: https://public.tableau.com https://maps.googleapis.com https://maps.gstatic.com https://*.tableau.yjbservices.yjb.gov.uk; frame-ancestors 'none';"
    }
  }
}
