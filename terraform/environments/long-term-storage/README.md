...
_If you have any questions surrounding this page please post in the [#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1) channel._
...
Long term storage account for data which must be kept but frequent access is no longer needed.

### **Service URLs:**

<!--  The URL(s) of the service’s production environment, and test environments if possible-->
No services running in the account
...
[#ask-modernisation-platform](https://mojdt.slack.com/archives/C01A7QK5VM1)
### **Hosting environment:**
