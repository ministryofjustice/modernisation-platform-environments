...
EOF
  ...
  depends_on = [
    aws_athena_named_query.main_table_connector_internal,
    aws_athena_named_query.http_requests_connector_internal,
    aws_athena_named_query.main_table_opa,
    aws_athena_named_query.http_requests_opa,
    aws_athena_named_query.main_table_adaptor_internal,
    aws_athena_named_query.http_requests_adaptor_internal,
