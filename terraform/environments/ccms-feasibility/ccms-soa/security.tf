...
resource "aws_security_group" "alb_admin" {
  name        = "${local.component_name}-${local.env_label}-admin-alb-sg"
...
resource "aws_vpc_security_group_egress_rule" "alb_admin_egress_ecs_tasks" {
  security_group_id            = aws_security_group.alb_admin.id
...
resource "aws_security_group" "alb_managed" {
  name        = "${local.component_name}-${local.env_label}-managed-alb-sg"
...
resource "aws_vpc_security_group_egress_rule" "alb_managed_egress_ecs_tasks" {
  security_group_id            = aws_security_group.alb_managed.id
