...
resource "aws_cloudwatch_metric_alarm" "maat_EscCPUoverThreshold" {
  ...
  alarm_actions      = [aws_sns_topic.Sev5SnsTopicArn.arn, aws_sns_topic.AlertCrimeAppsSnsTopicArn.arn]
  ok_actions         = [aws_sns_topic.Sev5SnsTopicArn.arn, aws_sns_topic.AlertCrimeAppsSnsTopicArn.arn]
...
resource "aws_cloudwatch_metric_alarm" "maat_EcsMemoryOverThreshold" {
  ...
  period             = "60"
  evaluation_periods = "5"
  alarm_actions      = [aws_sns_topic.Sev5SnsTopicArn.arn]
  ok_actions         = [aws_sns_topic.Sev5SnsTopicArn.arn]
