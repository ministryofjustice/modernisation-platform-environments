...
module "fabric_oidc_provider" {
  ...
  source = "git::https://github.com/ministryofjustice/terraform-aws-moj-data-factory-modules.git//modules/fabric-oidc-provider?ref=9f5634c0d1d450ed2ee9614ffc4e9613a492bc31"
...
module "fabric_iam_role" {
  count  = local.fabric_oidc_enabled ? 1 : 0
  source = "git::https://github.com/ministryofjustice/terraform-aws-moj-data-factory-modules.git//modules/fabric-iam-role?ref=9f5634c0d1d450ed2ee9614ffc4e9613a492bc31"
