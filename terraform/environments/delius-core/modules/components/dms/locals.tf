locals {
  ...
  dms_s3_repository_list_by_repository_role_name = "${var.env_name}-dms-s3-bucket-list-by-repository-role"
  dms_s3_repository_list_by_client_role_name = "${var.env_name}-dms-s3-bucket-list-by-client-role"
