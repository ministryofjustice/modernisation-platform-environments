...
resource "aws_ecs_task_definition" "pui" {
  ...
  container_definitions = templatefile(
    "${path.module}/templates/task_definition_pui.json.tpl",
    {
      ...
      spring_datasource_username                                    = "${aws_secretsmanager_secret.opahub_secrets.arn}:spring_datasource_username::"
      spring_datasource_password                                    = "${aws_secretsmanager_secret.opahub_secrets.arn}:spring_datasource_password::"
      spring_datasource_url                                         = "${aws_secretsmanager_secret.opahub_secrets.arn}:spring_datasource_url::"
      idp_cert                                                      = "${aws_secretsmanager_secret.opahub_secrets.arn}:idp_cert::"
      spcert                                                        = "${aws_secretsmanager_secret.opahub_secrets.arn}:spcert::"
      spprivatekey                                                  = "${aws_secretsmanager_secret.opahub_secrets.arn}:spprivatekey::"
      idpLogoutUrl                                                  = local.application_data.accounts[local.environment].idpLogoutUrl
      idpMetadataUrl                                                = "${aws_secretsmanager_secret.opahub_secrets.arn}:idpMetadataUrl::"
      loginUrl                                                      = "${aws_secretsmanager_secret.opahub_secrets.arn}:loginUrl::"
      postcodeApiUrl                                                = "${aws_secretsmanager_secret.opahub_secrets.arn}:postcodeApiUrl::"
      postcodeApiKey                                                = "${aws_secretsmanager_secret.opahub_secrets.arn}:postcodeApiKey::"
      ...
      ccms_soa_soapHeaderUserPassword                               = "${aws_secretsmanager_secret.opahub_secrets.arn}:ccms_soa_soapHeaderUserPassword::"
      ccms_soa_soapHeaderUserName                                   = "${aws_secretsmanager_secret.opahub_secrets.arn}:ccms_soa_soapHeaderUserName::"
      user_management_api_access_token                              = "${aws_secretsmanager_secret.opahub_secrets.arn}:user_management_api_access_token::"
      user_management_api_hostname                                  = "${aws_secretsmanager_secret.opahub_secrets.arn}:user_management_api_hostname::"
      ...
      idpIdentityID                                                 = "${aws_secretsmanager_secret.opahub_secrets.arn}:idpIdentityID::"
      IdpSamlMockEnabled                                            = local.application_data.accounts[local.environment].IdpSamlMockEnabled
      SpEntityId                                                    = "${aws_secretsmanager_secret.opahub_secrets.arn}:SpEntityId::"
      SpEntityUrl                                                   = "${aws_secretsmanager_secret.opahub_secrets.arn}:SpEntityUrl::"
