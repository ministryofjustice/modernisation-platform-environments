module "ec2_instance" {
  ...
  source = "github.com/ministryofjustice/modernisation-platform-terraform-ec2-instance?ref=4c4c58aacea4a50b8b85ad2afa9cfd8353eb982a" # replace managed_policy_arns argument in module with aws_iam_role_policy_attachment
